-- Schema SQL pour l'application d'échecs

-- Table pour stocker les connexions aux plateformes (Lichess, Chess.com)
CREATE TABLE IF NOT EXISTS user_platforms (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id UUID NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE,
  platform TEXT NOT NULL CHECK (platform IN ('lichess', 'chesscom')),
  platform_username TEXT NOT NULL,
  access_token TEXT, -- À crypter en production avec pgcrypto
  refresh_token TEXT, -- À crypter en production avec pgcrypto
